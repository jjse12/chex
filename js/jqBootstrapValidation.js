      ...
      ajax: {
		...
		builtInValidators: {
			...
			passwordagain: {
				...
				type: "match",
				match: "password",
				message: "Contraseñas no coinciden<!-- data-validator-paswordagain-message to override -->"
			},
			positive: {
				name: "Positive",
				type: "shortcut",
			...
			number: {
				...
				type: "regex",
				regex: "([+-]?\\\d+(\\\.\\\d*)?([eE][+-]?[0-9]+)?)?",
				message: "Debe ingresar un numero<!-- data-validator-number-message to override -->"
			},
			integer: {
				name: "Integer",
				type: "regex",
