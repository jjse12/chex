...
<div class="container" align="center" id="divFacturaOpciones"
    ...
    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12' style="padding-top: 6px;">
        ...
        <div class='col-lg-8 col-md-8 col-sm-8 col-xs-12'>
            <button id="btnPDF" onclick="generarPDF()" class="btn-lg btn-primary" align="center" style="width:49%; text-align: center ;">Generar PDF</button>
            <button id="btnSetVisible" onclick="setearVisibles()" class="btn-lg btn-warning" align="center" style="width: 49%; text-align: center ;">Marcar como enviados</button>
        </div>
    </div>
</div>